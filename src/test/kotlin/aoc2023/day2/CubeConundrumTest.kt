...
class CubeConundrumTest {
    ...
    @Test
    fun testPart1() {
        Assertions.assertEquals(listOf(1, 2, 5).sum(), CubeConundrum().validGamesSum(testPart1.lines(), 12, 13, 14))
    }

    @Test
    fun testPart2() {
        Assertions.assertEquals(
            listOf(48, 12, 1560, 630, 36).sum(),
            CubeConundrum().validGamesPowerSum(testPart1.lines())
        )
    }

    @Test
    fun solvePart1() {
        Assertions.assertEquals(2776, CubeConundrum().validGamesSum(part1.lines(), 12, 13, 14))
    }

    @Test
    fun solvePart2() {
        Assertions.assertEquals(68638, CubeConundrum().validGamesPowerSum(part1.lines()))
    }
